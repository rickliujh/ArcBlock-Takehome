...
describe('testing of /api', () => {
  ...
  test('pageSize not a int', done => {
    request(app)
      .get('/txs?pageSize=\"1000\"&pageNum=2&address=0xc5102fE9359FD9a28f877a67E36B0F050d81a3CC')
      .then(response => {
        expect(response.statusCode).toBe(400)
        expect(response.body).toEqual(mockRes[400].response)
      })
    done()
  })

  test('pageSize overcome', done => {
    request(app)
      .get('/txs?pageSize=1001&pageNum=2&address=0xc5102fE935D9a28f877a67E36B0F050d81a3CC')
      .then(response => {
        expect(response.statusCode).toBe(400)
        expect(response.body).toEqual(mockRes[400].response)
      })
  ...
  test('address invalid', done => {
    request(app)
      .get('/txs?pageSize=1000&pageNum=2&address=0xc5102fE935D9a28f877a67E36B0F050d81a3CC')
      .then(response => {
        expect(response.statusCode).toBe(400)
        expect(response.body).toEqual(mockRes[400].response)
      })
